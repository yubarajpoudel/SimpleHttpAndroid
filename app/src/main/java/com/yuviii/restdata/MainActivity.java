...
//    }
    public void testPutMethod() {
        ...
        DataRequestPair requestPair = DataRequestPair.create(sampleJSON);
        DataRequest request = DataRequest.getInstance();
        request.addDataRequestPair(requestPair);
        request.addUrl("https://www.gorakhadepartmentstores.com/api/rest/account/password/");
        request.addHeaders(new String[]{"Authorization"}, new String[]{"Bearer a304fd213c730859fa96b25635bea1b2866895c4"});
        request.addMethod(Method.PUT);
        ...
        requestManager.addOnDataRecieveListner(new OnDataRecievedListener() {
            @Override
            public void onDataRecieved(Response response, Object object) {
                Log.d("MainActivity ", "PUT Test, response = " + response.getMessage() + " dataFromServer = " + object.toString());
            }
        });
        requestManager.getData();
...
//        RequestBody body = RequestBody.create(JSON, sampleJSON);
//
//        OkHttpClient client = new OkHttpClient();
//
//        Request request = new Request.Builder()
//                .url("https://www.gorakhadepartmentstores.com/api/rest/account/password/")
//                .put(body) //PUT
//                .addHeader("Authorization", "Bearer a304fd213c730859fa96b25635bea1b2866895c4")
//                .build();
//
...
//        });
        ...
        Log.d("MainActivity", "starting request");
